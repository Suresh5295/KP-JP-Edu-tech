...
export default function HomeoneRowourclinet() {
  const [sliderState, setSliderState] = React.useState(0);
  const sliderRef = React.useRef(null);

  return (
    <div className="relative z-[26] mt-[110px] h-[946px] self-stretch bg-[url(/public/images/img_group_2371.png)] bg-cover bg-no-repeat lg:h-auto md:h-auto">
      <div className="relative mt-[130px] h-[814px] content-center lg:h-auto md:h-auto">
        <div className="mx-auto flex w-full flex-col items-center">
          <div className="container-xs relative z-[28] flex flex-col items-end pl-14 pr-[698px] lg:px-5 md:px-5">
            <Heading
              as="p"
                ...
                <div className="relative ml-3 h-[512px] content-center self-stretch lg:h-auto md:ml-0 md:h-auto">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1 flex-col items-start">
                    <Img
                      ...
                      alt="Television"
                      className="relative z-[27] ml-40 h-[38px] md:ml-0"
                    />
                    <Img
        ...
        <Heading
          size="heading10xl"
          as="h1"
          className="absolute left-0 right-0 top-[6%] z-[29] m-auto w-max text-[128px] font-extrabold uppercase text-white-a700_01 lg:text-[48px] md:text-[48px]"
        >
          Testimonial
        </Heading>
      </div>
