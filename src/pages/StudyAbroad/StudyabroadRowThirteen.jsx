...
export default function StudyabroadRowThirteen() {
  return (
    <div className="absolute bottom-px left-0 right-0 m-auto flex-1">
      <div className="flex items-center md:flex-col">
        ...
        <div className="flex flex-1 flex-col items-start gap-[26px] md:self-stretch md:px-5">
          <div className="relative ml-9 h-[492px] self-stretch md:ml-0">
            <div className="absolute left-0 right-0 top-[9%] m-auto flex flex-1 flex-col items-start gap-[22px]">
              ...
              <a href="#" className="ml-4 lg:text-[48px] md:ml-0 md:text-[48px]">
                <Heading as="h5" className="font-playfairdisplay text-[64px] font-medium text-blue_gray-800_01">
                  Contact Us
                </Heading>
              </a>
              <Text
                as="p"
                className="ml-5 w-[58%] text-[20px] font-normal leading-[33px] tracking-[0.40px] text-black-900_02 lg:w-full lg:text-[17px] md:ml-0 md:w-full"
              >
                <span>
          ...
          <button
            size="9xl"
            shape="square"
            className="ml-14 min-w-[206px] font-nunitosans uppercase tracking-[0.64px] md:ml-0 sm:px-4"
          >
