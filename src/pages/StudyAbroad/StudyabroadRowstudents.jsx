    ...
    <div className="relative z-[4] h-[946px] bg-[url(/public/images/img_group_2371.png)] bg-cover bg-no-repeat lg:h-auto md:h-auto">
      <div className="relative mt-[130px] h-[814px] content-center lg:h-auto md:h-auto">
        <div className="mx-auto flex w-full flex-col items-center">
          ...
          <div className="relative mt-[-16px] flex justify-center self-stretch bg-gradient py-8 sm:py-4">
                ...
                <div className="relative ml-3 h-[512px] content-center self-stretch lg:h-auto md:ml-0 md:h-auto">
                      ...
                      items={[...Array(3)].map(() => (
                        <React.Fragment key={Math.random()}>
                          <div className="relative h-[390px] content-center lg:h-auto md:h-auto">
                            ...
                            <div className="absolute bottom-[24%] right-[-1px] my-auto ml-[122px] mr-auto flex flex-1 flex-col lg:ml-0 md:ml-0">
                              <Text
                                as="p"
                                className="w-[88%] text-[20px] font-normal leading-[30px] tracking-[0.40px] text-black-900_02 lg:w-full lg:text-[17px] md:w-full"
                              >
                                &quot;The team at Jp Edu Tech is incredibly knowledgeable and efficient. They helped me
                                gather all the necessary documents and ensured a smooth visa application process.
                  ...
                  <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1 flex-col items-start">
                    <Img
                      ...
                      alt="Television"
                      className="relative z-[5] ml-40 h-[38px] md:ml-0"
                    />
                    <Img
        ...
        <Heading
          size="heading10xl"
          as="h4"
          className="absolute left-0 right-0 top-[7%] z-[7] m-auto w-max text-[128px] font-extrabold uppercase text-white-a700_01 lg:text-[48px] md:text-[48px]"
        >
          Testimonial
        </Heading>
      </div>
